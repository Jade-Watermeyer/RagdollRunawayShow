...
public class PodiumLights : MonoBehaviour
{
    ...
    public GameObject off10;
    public GameObject off11;
    ...
    public GameObject on10;
    public GameObject on11;
    //public GameObject on12;
    ...
    void Update()
    {
        ...
        if (timer >= 1f && a == false)
        {
            ...
            off10.SetActive(false);
            off11.SetActive(false);
        ...
        if (timer >= 2f && b == false)
        {
            ...
            off8.SetActive(true);
            off9.SetActive(true);
            off10.SetActive(true);
            off11.SetActive(true);
            ...
            on8.SetActive(false);
            on9.SetActive(false);
            on10.SetActive(false);
            on11.SetActive(false);
            //on12.SetActive(false);
